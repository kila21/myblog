...
export const Bookmark = () => {
    ...
    const {data: posts, isError, isSuccess, isLoading} = useGetUserBookmarksQuery(isAuth!, {
        skip: !isAuth,
    ...
    return (
        ...
        {isError && <div className="text-center">Something went Wrong. Refresh page or back to home page.</div>}
        {posts && isSuccess &&
                <>
                    ...
                    <div className="w-full h-full flex flex-col items-center gap-2">
                        ...
                        <section className="w-full flex flex-wrap gap-10 p-10 justify-center mt-10">
                            ...
                            {posts && posts.results.length === 0 && <h3>You Have no posts Bookmarked!</h3>}
